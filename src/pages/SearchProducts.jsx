...
const SearchProducts = () => {
    ...
    const {products,categorys,latestProducts,priceRange,totalProduct,parPage} = useSelector(state => state.home)
    ...
    return (
        <div>
            ...
            <section className='py-16'>
                <div className='w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto'>
                    ...
                    <div className='w-full flex flex-wrap'>
                        <div className={`w-3/12 md-lg:w-4/12 md:w-full pr-8 ${filter ? 'md:h-0 md:overflow-hidden md:mb-6' : 'md:h-auto md:over md:mb-0'}`}>
                ...
                <div className='py-2 flex flex-col gap-5'>
                    ...
                    />
                <div>
                <span className='text-slate-800 font-bold text-lg'>R{Math.floor(state.values[0])} - R{Math.floor(state.values[1])}</span>
                        </div>
                    </div>
            ...
            <Products title='Latest Products' products={latestProducts}/>
                ...
                <div>
                    {
                        totalProduct > parPage && <Pagination pageNumber={pageNumber} setPageNumber={setPageNumber} totalItems={totalProduct} 
