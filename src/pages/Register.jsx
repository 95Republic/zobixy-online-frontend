    ...
    <div>
        <form onSubmit={register} className='text-slate-600'>
            <div className='flex flex-col gap-1 mb-2'>
                ...
                <input onChange={inputHandler} value={state.name} className='w-full px-3 py-2 border border-slate-200 outline-none focus:border-green-500 rounded-md' 
            ...
            <div className='flex flex-col gap-1 mb-2'>
                ...
                <input onChange={inputHandler} value={state.email} className='w-full px-3 py-2 border border-slate-200 outline-none focus:border-green-500 rounded-md' 
            ...
            <div className='flex flex-col gap-1 mb-2'>
                ...
                <input onChange={inputHandler} value={state.password} className='w-full px-3 py-2 border border-slate-200 outline-none focus:border-green-500 rounded-md' 
                type="password" name="password" id="password" placeholder="Password" required />
                
            </div>

            <button className='px-8 w-full pt-2 bg-[#059473] shadow-lg 
            hover:shadow-green-500/40 text-white rounded-md'>Register</button>
        </form>
