...
import { FaFacebook, FaFacebookF, FaHeart, FaInstagram } from 'react-icons/fa';
...
const ProductDetails = () => {
    ...
    <section>
        ...
        <div className='flex flex-col gap-5'>
         ...
         <div className='text-2xl text-red-500 font-bold flex gap-3'>
            {
                product.discount !== 0 ? <>
                Price: <h2 className='line-through'>R{product.price}</h2>
                <h2>R{product.price - Math.floor((product.price * product.discount) / 100)} (- {product.discount}%)</h2>
                </> : <h2>Price: R{product.price}</h2>
            }
          </div> 
    ...
    <ul className='flex justify-start items-center gap-3'>
        ...
        <li>
            <a className='w-[38px] h-[38px] hover:bg-[#059473] hover:text-white flex justify-center items-center bg-cyan-500 rounded-full text-white' href="#"> <FaXTwitter /> </a>
        </li>
        <li>
        ...
        <li>
            <a className='w-[38px] h-[38px] hover:bg-[#059473] hover:text-white flex justify-center items-center bg-blue-500 rounded-full text-white' href="#"> <FaInstagram /> </a>
        </li>
    </ul> 
    ...
    <div className='flex flex-col gap-5 mt-3 border p-3'>
        ...
        <Link className='block'>
            ...
            <div className='flex gap-2'>
                <h2 className='text-lg font-bold text-slate-600'>R{p.price}</h2>
...
<div className='w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto'>
    {
        relatedProducts.length !== 0 && <h2 className='text-2xl py-8 text-slate-600'>Related Products </h2>
    }
