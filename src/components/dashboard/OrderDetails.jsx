    ...
    <div className='bg-white p-5'>
        ...
        <div className='grid grid-cols-2 gap-3'>
            <div className='flex flex-col gap-1'>
                <h2 className='text-slate-600 font-semibold font-sans'>
                    ...
                    <p>
                        ...
                        <span className='text-slate-600 text-sm'>{myOrder.shippingInfo?.address}
            ...
            <div className='text-slate-600'>
                <h2 className='font-mono'>Price: R{myOrder.price} Include Shipping</h2>
                ...
                <p className='font-mono'> Order Status : <span className={`py-[1px] text-xs px-3 ${myOrder.delivery_status === 'paid' ? 'bg-green-300 text-green-800' : 'bg-red-300 text-red-800'} rounded-md`}>
                    ...
                    myOrder.products?.map((p,i) => <div key={i}>
                        <div className='flex gap-5 justify-start items-center text-slate-600'>
                            <div className='flex gap-2'>
                                <img className='w-[55px] h-[55px] rounded' src={p.images[0]} alt="" />
                        ...
                        <div className='pl-4 flex flex-col'>
                            <h2 className='text-md text-green-800'>R{p.price - Math.floor((p.price * p.discount) / 100)}</h2>
                            <p className='line-through'>R{p.price}</p>
                            <p>-{p.discount}%</p>
